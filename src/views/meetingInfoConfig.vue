<template>
  <div class="container">
    ...
    <div class="page">
      ...
      <div class="mainer">
        <el-form label-position="left" :model="meetingInfoFrom" ref="meetingInfoFromRef">
          <el-row class="title">会议信息详情</el-row>
          <el-card shadow="never">
            <div class="title_small slider_nav0">
              <span>会议基本信息</span>
            </div>
            <InputArea :inputInfo="meetingInfoFrom.meetingBaseInfo" currentTime="meetingBaseInfo"></InputArea>
          ...
          <el-card shadow="never">
            ...
            <InputArea
              :inputInfo="meetingInfoFrom.listCollectConfigDate"
              currentTime="listCollectConfigDate"
            ></InputArea>
          </el-card>
          <el-card shadow="never">
            ...
            <InputArea
              :inputInfo="meetingInfoFrom.listCollectConfigStatus"
              currentTime="listCollectConfigStatus"
            ></InputArea>
          </el-card>
        </el-form>
      </div>
    ...
    return {
      ...
      meetingInfoFrom: {
        ...
        meetApprovalConfig: [
          ...
          {
            name: "预录入名单是否需要审批", // inputLable的中文
            v_model: "meetDepartment",
            value: "", // 输入框的值
    ...
    dynamicValidateForm: function () {
      return function (name) {
        if (name.indexOf(".") != -1) {
          ...
          // console.log(arr);
          return { dynamicValidateForm: this.meetingInfoFrom[arr[0]][arr[1]] };
        } else {
          return {
            dynamicValidateForm: this.meetingInfoFrom[name],
          };
        }
      };
    },
