  ...
  <div class="container">
    ...
    <div class="page">
      ...
      <div class="mainer">
        ...
        <el-row class="title meeting_precent" v-if="fareRate !==-1">
          当前使用额度：
          <el-progress :percentage="fareRate" :color="customColors"></el-progress>
        </el-row>
        ...
        <div v-if="approvelStatus == '待审批'" class="title_allCheck">
          ...
          >全选</el-checkbox>
          <span>
            <el-button icon="el-icon-finished" type="text" size="small" @click="changeRange">按审批时间排列</el-button>
          </span>
        </div>
        <el-card
          v-for="(item,index) in waitapprovel(approvelStatus)"
          :key="index"
  ...
  methods: {
    ...
    goApprovelIndividual(id) {
      this.$router.push({
        ...
        query: { id: JSON.stringify(id), eorder_no: this.eorder_no },
      });
    },
